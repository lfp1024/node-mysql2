...
class Packet {
  ...
  readLengthCodedString(encoding) {
    // console.log('[mysql2]=============readLengthCodedString >> callee======',Function.caller);
    const len = this.readLengthCodedNumber();
    // TODO: check manually first byte here to avoid polymorphic return type?
    console.log(
      '[mysql2]=============readLengthCodedString >> len====== ',
      len
    );
    if (len === null) {
      return null;
    ...
    const res = StringParser.decode(
      this.buffer.slice(this.offset - len, this.offset),
      encoding
    );
    console.log(
      '[mysql2]=============readLengthCodedString >> res====== ',
      res
    );
    return res;
  }
  ...
  parseInt(len, supportBigNumbers) {
    console.log('[mysql2]>>>>>>> parseInt len=', len);
    if (len === null) {
      return null;
    }
    ...
    console.log('[mysql2]>>>>>>> parseInt str=', str);
    if (num.toString() === str) {
      return num;
    }
    return str;
  ...
  parseDateTime(timezone) {
    ...
    console.log('[mysql2]=====22222222222222====parseDateTime========', str);
    console.log(
      '[mysql2]======22222222222222222===parseDateTime >> timezone========',
      timezone
    );
    if (str === null) {
      return null;
    ...
    if (!timezone || timezone === 'local') {
      console.log('[mysql2]======22222222222222222===333333333333333========');
      return new Date(str);
    }
    console.log('[mysql2]======22222222222222222===444444444444========');
    return new Date(`${str}${timezone}`);
  }
  ...
  parseLengthCodedIntNoBigCheck() {
    console.log(
      '[mysql2 ==========77777777777777777777========= ],parseLengthCodedIntNoBigCheck'
    );
    return this.parseIntNoBigCheck(this.readLengthCodedNumber());
  }

  parseLengthCodedInt(supportBigNumbers) {
    console.log('[mysql2]>>>>>>> parseLengthCodedInt');
    const res = this.parseInt(this.readLengthCodedNumber(), supportBigNumbers);
    console.log('[mysql2]>>>>>>> parseLengthCodedInt res=', res);
    return res;
  }
